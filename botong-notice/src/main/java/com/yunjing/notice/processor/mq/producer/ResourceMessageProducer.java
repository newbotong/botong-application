 ...
 **/
@Component
public class ResourceMessageProducer extends AbstractMessageProducer<Message, SystemLogQueueConfiguration> {

    public ResourceMessageProducer(SystemLogQueueConfiguration configuration) {
        super(configuration);
    }
}
